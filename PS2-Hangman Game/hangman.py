...
def match_with_gaps(my_word, other_word):
    ...
    if len(my_word)==len(other_word):
        for i in my_word:
            if (i != '_') and (i not in other_word):
                return False
            elif (i =='_') and (other_word[count] in my_word):
                return False
            count += 1
    else:
        return False
    ...
    for i in wordlist:
        ...
        for j in my_word:
            ...
            if len(i)!=len(my_word):
                ...
                if (j != '_') and (j != i[count]):
                    case= False
                    break
                elif (j == '_') and (i[count] in my_word):
                    case=False
                    break
            count+=1
        if case==True:
